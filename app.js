...
app.post(/\/contact$/, (req, res) => {
  ...
  const body = req.body
	...
	var mailOptions = {
			...
			to: 'robertodelvalle@servifacil.com.mx, eugeniodelvalle@servifacil.com.mx, servicioaclientesdf@servifacil.com.mx, sfsvales@servifacil.com.mx, gestiondeservicios@servifacil.com.mx, jefventasdf@servifacil.com.mx, clientes@servifacil.com.mx, matias@steed.mx', // list of receivers (who receives)
